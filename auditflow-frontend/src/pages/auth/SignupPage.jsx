...
import { Mail, Lock, User, ArrowRight, Shield, Sparkles, CheckCircle2 } from 'lucide-react';
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-xl text-neutral-600 leading-relaxed">
                            Join thousands of enterprises already scaling their compliance and auditing operations.
                        </p>
                    </motion.div>
                    ...
                    >
                        {[
                            ...
                            { icon: Sparkles, text: 'AI-powered anomaly detection' },
                            { icon: Shield, text: 'Custom security policies & controls' },
                        ].map((feature, index) => (
                            <motion.div
                                key={index}
                    ...
                    <div className="glass rounded-3xl p-8 sm:p-10 shadow-large">
                        {isSuccess ? (
                            ...
                            >
                                ...
                                <p className="text-neutral-600">Your account has been created successfully. Redirecting to your dashboard...</p>
                            </motion.div>
                        ) : (
                            <>
                                {/* Mobile Logo */}
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    ...
                                    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.8 }} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <Input
                                            name="password"
                                            type="password"
                                            label="Password"
                                    ...
                                    >
                                        <p className="text-[11px] text-neutral-500 mb-4 px-1">
                                            By signing up, you agree to our <span className="text-primary-600 cursor-pointer">Terms of Service</span> and <span className="text-primary-600 cursor-pointer">Privacy Policy</span>.
                                        </p>
                                        <Button
                                            type="submit"
                                            variant="gradient"
